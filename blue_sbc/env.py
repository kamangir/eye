...
BLUE_SBC_SESSION_TEMPERATURE_IMAGER_PERIOD = get_env(
    "BLUE_SBC_SESSION_TEMPERATURE_IMAGER_PERIOD", 300
)
BLUE_SBC_SESSION_TEMPERATURE_MESSENGER_PERIOD = get_env(
    "BLUE_SBC_SESSION_TEMPERATURE_MESSENGER_PERIOD", 60
)
BLUE_SBC_SESSION_TEMPERATURE_REBOOT_PERIOD = get_env(
    "BLUE_SBC_SESSION_TEMPERATURE_REBOOT_PERIOD", 14400
)
BLUE_SBC_SESSION_TEMPERATURE_SCREEN_PERIOD = get_env(
    "BLUE_SBC_SESSION_TEMPERATURE_SCREEN_PERIOD", 4
)
