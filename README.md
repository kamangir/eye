...
`blue-sbc` is an [`abcli`](https://github.com/kamangir/awesome-bash-cli) plugin for edge computing on single board computers. Click on each design for more info on the hardware setup.
...
Here, `<env-name>` indicates [the design](https://github.com/kamangir/blue-bracket).